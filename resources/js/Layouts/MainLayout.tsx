...
import { faBarsStaggered, faHouse, faUtensils, faXmark } from '@fortawesome/free-solid-svg-icons';
        ...
        <div>
            <div className="relative">
                <div className="drawer">
                    ...
                    <div className="drawer-content z-50 fixed top-0 left-0 max-w-32 bg-primary-cfc py-3 px-5">
                        <Link href='/'>
                            ...
                            <div className='text-white mt-3 ml-2'>
                                {
                                    active ?
                                        ...
                                        <FontAwesomeIcon icon={faBarsStaggered} className='text-3xl font-thin' />
                                }
                            </div>
                        </label>
                    </div>
